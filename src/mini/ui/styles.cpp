...
void SetupImGuiStyle() {
  ...
  style.Colors[ImGuiCol_FrameBgHovered]        = ImVec4(0.37339056f, 0.0f, 0.0f, 1.0f);
  ...
  style.Colors[ImGuiCol_ScrollbarGrab]         = ImVec4(0.3218884f, 0.0f, 0.0f, 1.0f);
  style.Colors[ImGuiCol_ScrollbarGrabHovered]  = ImVec4(0.5493562f, 0.0f, 0.0f, 1.0f);
  style.Colors[ImGuiCol_ScrollbarGrabActive]   = ImVec4(0.6866953f, 0.0f, 0.0f, 1.0f);
  style.Colors[ImGuiCol_CheckMark]             = ImVec4(1.0f, 0.49803925f, 0.49803925f, 1.0f);
  style.Colors[ImGuiCol_SliderGrab]            = ImVec4(1.0f, 0.49803925f, 0.49803925f, 1.0f);
  style.Colors[ImGuiCol_SliderGrabActive]      = ImVec4(1.0f, 0.49803925f, 0.49803925f, 1.0f);
  style.Colors[ImGuiCol_Button]                = ImVec4(0.11764706f, 0.13333334f, 0.14901961f, 1.0f);
  style.Colors[ImGuiCol_ButtonHovered]         = ImVec4(0.31759655f, 0.0f, 0.0f, 1.0f);
  style.Colors[ImGuiCol_ButtonActive]          = ImVec4(0.62231755f, 0.0f, 0.0f, 1.0f);
  style.Colors[ImGuiCol_Header]                = ImVec4(0.14117648f, 0.16470589f, 0.20784314f, 1.0f);
  style.Colors[ImGuiCol_HeaderHovered]         = ImVec4(0.30472106f, 0.0f, 0.0f, 1.0f);
  style.Colors[ImGuiCol_HeaderActive]          = ImVec4(0.30890235f, 0.51353925f, 0.9227468f, 1.0f);
  ...
  style.Colors[ImGuiCol_ResizeGripHovered]     = ImVec4(1.0f, 0.49803925f, 0.49803925f, 1.0f);
  style.Colors[ImGuiCol_ResizeGripActive]      = ImVec4(1.0f, 1.0f, 1.0f, 1.0f);
  style.Colors[ImGuiCol_Tab]                   = ImVec4(0.078431375f, 0.08627451f, 0.101960786f, 1.0f);
  style.Colors[ImGuiCol_TabHovered]            = ImVec4(0.7167382f, 0.0f, 0.0f, 1.0f);
  ...
  style.Colors[ImGuiCol_PlotHistogram]         = ImVec4(1.0f, 0.360515f, 0.0f, 1.0f);
